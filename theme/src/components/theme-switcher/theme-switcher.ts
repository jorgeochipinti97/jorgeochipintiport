...
export class ThemeSwitcher extends LitElement {
  ...
  firstUpdated() {
    ...
    const _heroImage = document.querySelector('#home-hero-image') as HTMLImageElement;
		if (theme === 'default') {
			_heroImage.src = '/assets/images/home/guinticlassic.jpg';
		}
		if (theme === 'dark') {
			_heroImage.src = '/assets/images/home/guintiwhite.jpg';
		}
		if (theme === 'earth') {
			_heroImage.src = '/assets/images/home/guinti1.jpg';
		}
		if (theme === 'ocean') {
			_heroImage.src = '/assets/images/home/guintiazul.jpg';
		}
		if (theme === 'sand') {
			_heroImage.src = '/assets/images/home/guintisand.jpg';
		}
